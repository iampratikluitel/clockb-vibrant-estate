...
const Faqs = () => {
  ...
  const faqItems = [
    // Investment & Returns
    {
      ...
      answer:
        "The minimum investment is NPR 5 Lakhs per investor. For those opting for land exit, the minimum investment required is NPR 48 Lakhs.",
    },
    {
      id: "item-2",
      category: "investment",
    ...
    },
    {
      ...
      answer:
        "The returns depend on market appreciation, project development, and demand. Based on past trends in similar projects, land value appreciation has been over 2X within a few years.",
    },
    {
      id: "item-4",
      category: "investment",
      ...
      answer:
        "Investors opting for cash exit will receive their investment amount plus returns after applicable fees and government taxes. Investors choosing land exit will be able to select land equal to their investment + returns, after deductions.",
    },
    {
      id: "item-5",
      category: "investment",
      ...
      answer:
        "Yes, the investment is legally structured and managed by Investment Circle P. Ltd. All transactions are conducted with complete transparency and legal documentation.",
    },
    ...
    // Land & Location
    {
      ...
      answer:
        "The Saukhel Real Estate Project is located 8 KM from Ekantakuna Ring Road and 4.5 KM from Bhaisipati, near the Kathmandu-Terai Fast Track Road and the upcoming Bagmati Bridge.",
    },
    {
      id: "item-7",
      category: "land",
      ...
      answer:
        "The site is positioned near major infrastructure projects, including:\n✔️ Kathmandu-Terai Fast Track – Connecting Kathmandu to Nijgadh International Airport.\n✔️ Bagmati Bridge – Connecting Dakshinkali and Lalitpur.\n✔️ Lalitpur Smart City – A planned urban expansion project.\n✔️ Dry Port & Fast Track Bus Stop – Making it a strategic location for residential & commercial use.",
    },
    {
      id: "item-8",
      category: "land",
      question:
        "How much of the project land will be used for infrastructure development?",
      answer:
        "Approximately 30% of the land will be allocated for roads, open spaces, and amenities in compliance with urban planning regulations (±5% variation expected).",
    },
    {
      id: "item-9",
      category: "land",
      ...
      answer:
        "Yes! We encourage investors to schedule a site visit to see the development firsthand.",
    },
    ...
    },
    {
      ...
      answer:
        "Priority is based on investment amount and date of investment completion. Investors with larger and earlier investments will have first choice.",
    },
    {
      id: "item-12",
      category: "exit",
      ...
      answer:
        "No additional charges for development. However, standard government taxes and management fees will be deducted before returns are disbursed.",
    },
    {
      id: "item-13",
      category: "exit",
      ...
      answer:
        "Yes, all applicable government taxes will be deducted at source before investors receive their returns.",
    },
    ...
    // Project Development & Management
    {
      ...
      answer:
        "The project is managed by Investment Circle P. Ltd., with key personnels and an experienced Engineering & Planning Partner overseeing all development activities.",
    },
    {
      id: "item-15",
      category: "project",
      ...
      answer:
        "Yes! We facilitate large-scale investments and parallel projects under an institution's name.",
    },
    {
      id: "item-16",
      category: "project",
      ...
      answer:
        "Investors receive regular progress reports, and we also host annual investor meetings to provide updates on milestones, financials, and future plans.",
    },
