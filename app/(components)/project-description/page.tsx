...
const ProjectDescription = () => {
  return (
    <div className="min-h-screen bg-estates-gray-100">
        ...
        <div className="container mx-auto">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="text-gray-600 mb-10 animate-fade-in delay-100">
              <p className="mb-4">
                Saukhel Real Estate Project is a strategically planned urban development designed to provide high-value 
                investment opportunities while ensuring sustainable and modern living. Situated in a prime location, 
                the project offers transparent investment models, legal security, and high ROI potential for investors 
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-white p-8 rounded-lg shadow-md transform hover:scale-105 transition-transform duration-300">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-bold text-estates-secondary">Vision</h3>
                </div>
                <p className="text-gray-600">
                  To create a thriving, sustainable, and high-value real estate development that drives 
                  urban transformation and investor prosperity.
                </p>
              </div>
              <div className="bg-white p-8 rounded-lg shadow-md transform hover:scale-105 transition-transform duration-300">
                <div className="flex items-center mb-4">
                  <FileText className="w-8 h-8 text-estates-primary mr-3" />
                  <h3 className="text-xl font-bold text-estates-secondary">Mission</h3>
                </div>
                <p className="text-gray-600">
                  To establish a legally secure, well-planned, and high-growth real estate destination 
                  with modern infrastructure, premium amenities, and strong investor returns.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <CoreValueCard 
                icon={<ShieldCheck className="w-12 h-12 text-estates-primary" />} 
                title="Transparency" 
        ...
        <div className="container mx-auto">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-center text-gray-600 max-w-3xl mx-auto mb-12">
              Our project is developed over multiple phases, ensuring a structured and high-value progression.
            </p>
            
            <div className="bg-white p-8 rounded-lg shadow-md mb-12">
              <h3 className="text-xl font-bold text-estates-primary mb-6">Key Highlights</h3>
              <div className="grid md:grid-cols-3 gap-6">
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-estates-secondary mb-2">Total Land Area</h4>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-estates-secondary mb-2">Planned Infrastructure</h4>
                    <p className="text-gray-600">Roads, electricity, water, drainage, parks and open spaces</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="mt-1 mr-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-estates-secondary mb-2">Zoning</h4>
                    <p className="text-gray-600">Residential, commercial, mixed-use</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 px-4 md:px-8 lg:px-16 bg-white">
        <div className="container mx-auto">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-center text-gray-600 max-w-3xl mx-auto mb-12">
              Our project is carefully planned across three strategic phases to ensure sustainable growth and maximum value
            </p>
      ...
      <section id="investment-model" className="py-16 px-4 md:px-8 lg:px-16 bg-estates-gray-200">
        <div className="container mx-auto">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-2xl md:text-3xl font-bold text-center text-estates-primary mb-4">
              Investment Model & Benefits
            ...
            <p className="text-center text-gray-600 max-w-3xl mx-auto mb-12">
              A transparent and flexible investment approach designed for both seasoned investors and first-time buyers
            </p>
              ...
              <div className="bg-white p-8 rounded-lg shadow-md">
                ...
                <div className="space-y-6">
                  <div className="flex">
                    ...
                    <div>
                      <h4 className="font-semibold text-estates-secondary mb-1">Land Ownership Model</h4>
                      <p className="text-gray-600 text-sm">Direct purchase, lease options, fractional investment structures</p>
                    </div>
                  </div>
                  ...
                  <div className="flex">
                    ...
                    <div>
                      <h4 className="font-semibold text-estates-secondary mb-1">Projected Returns</h4>
                      <p className="text-gray-600 text-sm">15-20% annual ROI with consistent appreciation</p>
                    </div>
                  </div>
                  ...
                  <div className="flex">
                    ...
                    <div>
                      <h4 className="font-semibold text-estates-secondary mb-1">Exit Strategies</h4>
                      <p className="text-gray-600 text-sm">Resale, rental income, investment liquidation</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white p-8 rounded-lg shadow-md">
                ...
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-semibold text-estates-secondary">High ROI and Asset Appreciation</h4>
                      <p className="text-gray-600 text-sm">Consistent growth in property value over time</p>
                    </div>
                  </li>
                  ...
                  <li className="flex items-start">
                    <Check className="w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-estates-secondary">100% Legal Security & Transparency</h4>
                      <p className="text-gray-600 text-sm">All transactions legally documented and verified</p>
                    </div>
                  </li>
                  ...
                  <li className="flex items-start">
                    <Check className="w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-estates-secondary">Exclusive Early Access to Premium Plots</h4>
                      <p className="text-gray-600 text-sm">First choice of prime locations for early investors</p>
                    </div>
                  </li>
                  ...
                  <li className="flex items-start">
                    <Check className="w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-estates-secondary">Infrastructure-Driven Growth Potential</h4>
                      <p className="text-gray-600 text-sm">Value increase tied to continuous development</p>
                    </div>
                  </li>
                </ul>
              </div>
      ...
      <section className="py-16 px-4 md:px-8 lg:px-16 bg-white">
        <div className="container mx-auto">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-center text-gray-600 max-w-3xl mx-auto mb-12">
              World-class facilities designed for modern, comfortable, and sustainable living
            </p>
            ...
            <div className="grid lg:grid-cols-2 gap-8 mb-12">
              ...
              <div>
                ...
                <div className="space-y-6">
                  <InfrastructureItem 
                    icon={<LayoutGrid className="w-5 h-5 text-estates-primary" />}
...
const CoreValueCard = ({ 
  ...
  return (
    <div className="bg-estates-gray-100 p-6 rounded-lg border border-estates-gray-300 hover:shadow-lg transition-all duration-300 text-center group">
      ...
      <h3 className="text-lg font-semibold text-estates-secondary mb-2">{title}</h3>
    ...
    <div className={`relative ${isActive ? "z-10" : ""}`}>
      ...
      `}>
        ...
        <div className="md:hidden flex items-center gap-2 mb-3">
          ...
          <span className="text-estates-primary font-semibold">Phase {phaseNumber}</span>
        </div>
        ...
        <h3 className={`text-xl font-bold mb-3 ${isActive ? "text-estates-primary" : "text-estates-secondary"}`}>
          {title}
        </h3>
