  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-muted-foreground">
        Learn about the team and partners behind our visionary real estate
        development project
      </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <div className="flex flex-col md:flex-row gap-4 justify-center">
              <Button className="bg-white text-estates-primary hover:bg-white/90">
                <Phone className="w-5 h-5" />
                Book a Consultation
              </Button>
              <Button className="border border-white bg-transparent hover:bg-white/10">
