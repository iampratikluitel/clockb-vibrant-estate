            ...
            >
              <div className="relative h-60 overflow-hidden">
                ...
                {project.status === "ongoing" && (
                  <div className="absolute top-4 right-4 bg-green-600 text-white text-sm font-medium py-1 px-3 rounded-full">
                    Ongoing
                  </div>
                )}
                {project.status === "completed" && (
                  <div className="absolute top-4 right-4 bg-gray-700 text-white text-sm font-medium py-1 px-3 rounded-full">
                    Completed
                  </div>
                )}
              </div>
