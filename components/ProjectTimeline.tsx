...
const timelineData: TimelineMilestone[] = [
  ...
  },
  {
    ...
    description: "Launch of a housing project, featuring modern living spaces. Development of community amenities, including parks, commercial spaces, and public utilities. Strategic partnerships for sustainable urban planning and high-value infrastructure. Exit planning for investors, ensuring maximum returns and a seamless transition."
  }
];

// Timeline milestone background colors
